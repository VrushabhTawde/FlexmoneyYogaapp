...
app.post('/signup', (req, res) => {    const sql = "INSERT INTO login (name,age, batch_time,email,password) VALUES (?)";    
const values = [        req.body.name, req.body.age, req.body.batch_time,       req.body.email,        req.body.password    ]  
